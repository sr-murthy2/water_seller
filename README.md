...
This process installs the OasisLMF (v1.28.2) package locally and installs the required dependencies. This is essential if you
...
```
This will install the [OasisLMF](https://github.com/OasisLMF/OasisLMF) (v1.28.2) package  directly from the [corresponding tag](https://github.com/OasisLMF/OasisLMF/releases/tag/1.28.2).
